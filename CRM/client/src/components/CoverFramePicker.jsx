 ...
 *
 * `initialMs` seeds the initial position — typically set by the upload
 * pipeline to the first spoken word's timestamp (bulk-upload.js extracts
 * it from ElevenLabs Scribe word-level timestamps).
 */
export default function CoverFramePicker({ videoUrl, onChange, initialMs = null }) {
  ...
  function handleMetadata() {
    ...
    if (initialMs != null && videoRef.current) {
