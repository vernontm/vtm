            ...
            <div style={{ background: '#111328', border: '1px solid #252523', borderRadius: 8, padding: '12px 14px' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <button
                  onClick={handleSync}
                  disabled={syncing}
                  style={{ display: 'flex', alignItems: 'center', gap: 5, padding: '5px 10px', borderRadius: 6, fontSize: 11, fontWeight: 600, cursor: syncing ? 'not-allowed' : 'pointer', background: '#111110', border: '1px solid #252523', color: '#ff9b26', opacity: syncing ? 0.7 : 1 }}
                >
