...
export default function MeetingDetail() {
  ...
  if (loading) {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100%', minHeight: 400, background: 'var(--bg)', color: 'var(--muted)', gap: 12 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
              <h1 style={{ fontSize: 21, fontWeight: 800, color: 'var(--text)', margin: 0 }}>{meeting?.title}</h1>
              <StatusBadge status={meeting?.status} />
            </div>
            <div style={{ fontSize: 12, color: 'var(--muted)', marginTop: 5, display: 'flex', alignItems: 'center', gap: 14, flexWrap: 'wrap' }}>
            ...
            {activeTab === 'overview' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                    ...
                    <div style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 10, overflow: 'hidden' }}>
                      ...
                      {webViewUrl && (
                        <div style={{ padding: '8px 14px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderTop: '1px solid var(--border)' }}>
                          <span style={{ fontSize: 11, color: 'var(--muted)' }}>Recording from Google Drive</span>
                          <a
                            href={webViewUrl}
                            target="_blank"
                            rel="noreferrer"
                            style={{ fontSize: 11, color: 'var(--orange)', display: 'flex', alignItems: 'center', gap: 4, textDecoration: 'none' }}
                          >
                ...
                <div>
                  ...
                  {summarizing ? (
                    <div style={{ background: 'var(--surface)', border: '1px solid #784bd140', borderRadius: 10, padding: 28, textAlign: 'center' }}>
                      ...
                      <div style={{ fontSize: 11, color: 'var(--muted)', marginTop: 5 }}>This may take a few seconds</div>
                    </div>
                  ) : summary ? (
                    ...
                    <div style={{ background: 'var(--surface)', border: '1px solid #784bd130', borderRadius: 10, padding: '30px 20px', textAlign: 'center' }}>
                    ...
                    {meeting.participants.map((p, i) => {
                      ...
                      return (
                        <div key={i} style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 10, padding: '12px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
                          ...
                          <div style={{ flex: 1 }}>
                            <div className="private-value" style={{ fontSize: 13, fontWeight: 600, color: 'var(--text)' }}>
                              {p.name && p.name !== p.email ? p.name : p.email}
                            </div>
                            {p.name && p.name !== p.email && (
                              <div className="private-value" style={{ fontSize: 11, color: 'var(--muted)', marginTop: 2 }}>{p.email}</div>
                            )}
                          </div>
                          {linkedLead && (
        ...
        <div style={{
          ...
          <div style={{ padding: '14px 16px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexShrink: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
              ...
              <span style={{ fontSize: 14, fontWeight: 700, color: 'var(--text)' }}>Meeting Sidekick</span>
          ...
          {/* Input */}
          <form onSubmit={handleSendChat} style={{ padding: '10px 12px', borderTop: '1px solid var(--border)', flexShrink: 0 }}>
                ...
                return (
                  ...
                  >
                    ...
                    {linkingLeadId === lead.id ? (
                      ...
                      <span style={{ fontSize: 11, color: 'var(--orange)' }}>Link →</span>
                    )}
                  </div>
                );
              })}
