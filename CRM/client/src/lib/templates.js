// Automation templates as the web CRM sees them. Mirrors mobile/lib/templates.js
// and New/api/_lib/automations.js: the same defaults, placeholders, sample
// values and fill rules, so the preview on the Settings page matches what the
// server sends and what the iPhone app shows. Change all three together.
