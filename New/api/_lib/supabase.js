...
const ALL_PAGES = [
  ...
  'dashboard','clients','projects','appointments','employees','invoices','subscriptions','email','settings',
  ...
  'quick-notes','notifications','deals','scripts',
  'training','team','products','accounts','admin-users',
];
